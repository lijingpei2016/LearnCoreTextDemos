//
//  CTGestureActionDemoController.m
//  CoreTextDemo
//
...
@interface CTGestureActionDemoController ()
@property (nonatomic, strong) YTDrawView *textDrawView;
@end

@implementation CTGestureActionDemoController
